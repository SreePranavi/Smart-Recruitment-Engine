...
corpus = {'SDE1_Tooling': 'Python , Javascript , Kubernetes' , 'SDE1_MARLEY' : 'Python , Javascript , PHP , Kubernetes'}
...
class CosineSimilarityEngine :
  ...
  def cosine_similarity_engine(self, data):
    ...
    cosine_similarity_matrix = cosine_similarity(transformed_data, self.training_matrix)
